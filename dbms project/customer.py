...
class Cust_Win:
    ...
    # =========title===============
     ...
     # ===============logo=================
        ...
        labelframeleft=LabelFrame(self.root,bd=2,relief=RIDGE,text="Customer Details",font=("times new roman",12,"bold"),bg="white",fg="black",padx=2,)
        labelframeleft.place(x=5,y=50,width=425,height=490)

        # ==========labels and entry==================
        # custref
        lbl_cust_ref=Label(labelframeleft,font=("arial",12,"bold"),text="Customer Ref:",padx=2,pady=6)
        ...
        # postcode
        lblPostCode=Label(labelframeleft,text="Pincode:",font=("arial",12,"bold"),padx=2,pady=6)
        ...
        combo_Nationality["value"]=("Indian","USA","Dubai")
        ...
        self.Cust_Details_Table=ttk.Treeview(details_table,column=("ref","name","father","gender","post","mobile","email","nationality","idproof","idnumber","address"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y)
